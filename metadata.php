...
",
    ...
    'templates'     => [
        'molliewebhook.tpl' => 'Application/views/hook/tpl/molliewebhook.tpl',
        'mollie_config_banktransfer.tpl' => 'Application/views/admin/tpl/paymentconfig/mollie_config_banktransfer.tpl',
        'mollie_config_giftcard.tpl' => 'Application/views/admin/tpl/paymentconfig/mollie_config_giftcard.tpl',
        'mollie_config_ideal.tpl' => 'Application/views/admin/tpl/paymentconfig/mollie_config_ideal.tpl',
        'mollie_config_creditcard.tpl' => 'Application/views/admin/tpl/paymentconfig/mollie_config_creditcard.tpl',
        'mollie_config_applepay.tpl' => 'Application/views/admin/tpl/paymentconfig/mollie_config_applepay.tpl',
        'mollie_issuers.tpl' => 'Application/views/frontend/tpl/mollie_issuers.tpl',
        'mollie_issuers_dropdown.tpl' => 'Application/views/frontend/tpl/mollie_issuers_dropdown.tpl',
        'mollie_issuers_radio.tpl' => 'Application/views/frontend/tpl/mollie_issuers_radio.tpl',
        'mollie_payment_showicons.tpl' => 'Application/views/frontend/tpl/mollie_payment_showicons.tpl',
        'mollieideal.tpl' => 'Application/views/frontend/tpl/mollieideal.tpl',
        'molliegiftcard.tpl' => 'Application/views/frontend/tpl/molliegiftcard.tpl',
        'mollieapplepay.tpl' => 'Application/views/frontend/tpl/mollieapplepay.tpl',
        'molliecreditcard.tpl' => 'Application/views/frontend/tpl/molliecreditcard.tpl',
        'mollieapplepaybutton.tpl' => 'Application/views/frontend/tpl/mollieapplepaybutton.tpl',
        'mollie_order_refund.tpl' => 'Application/views/admin/tpl/mollie_order_refund.tpl',
        'mollie_second_chance.tpl' => 'Application/views/email/tpl/mollie_second_chance.tpl',
        'mollie_module_main.tpl' => 'Application/views/admin/tpl/mollie_module_main.tpl',
    ...
    'blocks'        => [
        ['template' => 'module_config.tpl',                     'block' => 'admin_module_config_var',       'file' => 'out/blocks/mollie_module_config_var.tpl'],
        ['template' => 'payment_main.tpl',                      'block' => 'admin_payment_main_form',       'file' => 'out/blocks/mollie_admin_payment_main_form.tpl'],
        ['template' => 'page/checkout/inc/payment_other.tpl',   'block' => 'checkout_payment_longdesc',     'file' => 'out/blocks/mollie_checkout_payment_longdesc.tpl'],
        ['template' => 'mollie_payment_showicons.tpl',          'block' => 'checkout_payment_longdesc',     'file' => 'out/blocks/mollie_checkout_payment_longdesc.tpl'],
        ['template' => 'page/checkout/payment.tpl',             'block' => 'select_payment',                'file' => 'out/blocks/mollie_select_payment.tpl'],
        ['template' => 'page/checkout/payment.tpl',             'block' => 'checkout_payment_errors',       'file' => 'out/blocks/mollie_checkout_payment_errors.tpl'],
        ['template' => 'page/details/inc/productmain.tpl',      'block' => 'details_productmain_tobasket',  'file' => 'out/blocks/mollie_details_productmain_tobasket.tpl'],
        ['template' => 'page/checkout/basket.tpl',              'block' => 'basket_btn_next_top',           'file' => 'out/blocks/mollie_basket_btn_next_top.tpl'],
        ['template' => 'page/checkout/basket.tpl',              'block' => 'basket_btn_next_bottom',        'file' => 'out/blocks/mollie_basket_btn_next_bottom.tpl'],
    ],
    'settings'      => [
