...
class Events
{
    ...
    protected static function addDatabaseStructure()
    {
        ...
        self::addColumnIfNotExists('oxorder', 'MOLLIEWASCAPTURED', "ALTER TABLE `oxorder` ADD COLUMN `MOLLIEWASCAPTURED` DOUBLE NOT NULL DEFAULT '0';");
        ...
        self::addColumnIfNotExists('oxorder', 'MOLLIECAPTUREMETHOD', "ALTER TABLE `oxorder` ADD COLUMN `MOLLIECAPTUREMETHOD` VARCHAR(64) CHARSET utf8 COLLATE utf8_general_ci DEFAULT '' NOT NULL;");
