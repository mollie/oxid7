...
$aLang = array(
    ...
    'SHOP_MODULE_sMollieCronjobLogLevel_standard'       => 'Estándar',
    ...
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS'          => 'Ignorar la dirección de entrega de Apple Pay Express',
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS_HELP'     => 'Tanto la dirección de entrega como la de facturación provienen normalmente de Apple Pay. Si esto está activado, se ignorará la dirección de entrega de Apple Pay y se utilizará la dirección de entrega activa en la tienda. Por ejemplo, útil para escenarios de recogida en tienda. Solo se aplica a Apple Pay Express (botón en el carrito o en la página de detalle del producto).',
    ...
    'MOLLIE_DIRECT_CAPTURE'                             => 'Capturar el importe de inmediato',
    'MOLLIE_AUTHORIZE_CAPTURE'                          => 'Autorizar solo el importe',
    'MOLLIE_AUTOMATIC_CAPTURE'                          => 'Capturar el importe automáticamente',
    'MOLLIE_SHIPPED_CAPTURE'                            => 'Capturar el importe automáticamente al enviar',
    ...
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE'                    => 'Mostrar método de pago desactivado cuando no esté disponible',
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE_HELP'               => 'Si está activo, el método de pago se mostrará como desactivado en la página de pago si no está disponible debido a la configuración de la moneda, los importes mínimos/máximos o las restricciones de país por parte de Mollie.',
);
