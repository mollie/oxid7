...
$aLang = array(
    ...
    'MOLLIE_ADMIN'                                      => 'Mollie',
    'MOLLIE_ADMIN_API_LOGS'                             => 'Journaux de l\'API',
    'MOLLIE_ADMIN_API_LOGS_MAIN'                        => 'Logs',
    'MOLLIE_ADMIN_API_LOGS_SELECT_ENTRY'                => 'Veuillez sélectionner un élément dans la liste du haut.',
    ...
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS'          => 'Ignorer l’adresse de livraison Apple Pay Express',
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS_HELP'     => 'L’adresse de livraison et l’adresse de facturation sont normalement fournies par Apple Pay. Si cette option est activée, l’adresse de livraison Apple Pay sera ignorée et l’adresse de livraison active dans la boutique sera utilisée. Par exemple, utile pour les scénarios de retrait en magasin. S’applique uniquement à Apple Pay Express (bouton sur le panier ou la page de détail du produit).',
    ...
    'MOLLIE_PAYMENT_DISABLED_ACTIVATION'                => 'Ce mode de paiement Mollie ne peut plus être activé, car il sera prochainement supprimé!',
    ...
    'MOLLIE_DIRECT_CAPTURE'                             => 'Capturer le montant immédiatement',
    'MOLLIE_AUTHORIZE_CAPTURE'                          => 'Autoriser uniquement le montant',
    'MOLLIE_AUTOMATIC_CAPTURE'                          => 'Capturer le montant automatiquement',
    'MOLLIE_SHIPPED_CAPTURE'                            => "Capturer le montant automatiquement à l'expédition",
    ...
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE'                    => 'Afficher le mode de paiement comme désactivé s\'il n\'est pas disponible',
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE_HELP'               => 'Si cette option est activée, le mode de paiement s\'affichera comme désactivé sur la page de paiement s\'il n\'est pas disponible en raison des paramètres de devise, des montants min/max ou des restrictions de pays de la part de Mollie.',
);
