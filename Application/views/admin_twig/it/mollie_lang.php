...
$aLang = array(
    ...
    'SHOP_MODULE_sMollieCronjobLogLevel_extended'       => 'Esteso',
    'SHOP_MODULE_sMollieCronjobLogLevel_none'           => 'Nessun log',
    'SHOP_MODULE_sMollieCronOrderExpiryActive'          => 'Cronjob "Cancella automaticamente gli ordini non pagati" attivo',
    'SHOP_MODULE_sMollieCronFinishOrdersActive'         => 'Cronjob "Completamento degli ordini pagati/autorizzati ma non completati" attivo',
    'SHOP_MODULE_iMollieCronFinishOrdersDays'           => 'Finestra temporale durante la quale si tenta di completare gli ordini pagati/autorizzati ma non completati',
    ...
    'HELP_SHOP_MODULE_sMollieCronFinishOrdersActive'    => 'Questo cronjob ha il compito di concludere gli ordini in cui il pagamento del cliente è andato a buon fine ma apparentemente il cliente non è tornato al negozio per completare il processo dell\'ordine. Il cron job finalizza solo gli ordini all\'interno del periodo configurato nel campo "Finestra temporale durante la quale si tenta di completare gli ordini pagati/autorizzati ma non completati".<br><br>Perché questo cronjob funzioni, oltre a questa casella di spunta dovete assicurarvi che il cronjob di Mollie sia impostato correttamente. Potete trovare informazioni su come impostare il cronjob nel README.md di questo modulo.',
    ...
    'MOLLIE_ALTLOGO_ERROR'                              => 'Si è verificato un errore durante il caricamento del file. Controlla i permessi della cartella SHOPROOT/vendor/mollie/mollie-oxid7/assets/img/',
    ...
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS'          => 'Ignora l’indirizzo di consegna Apple Pay Express',
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS_HELP'     => 'Sia l’indirizzo di consegna che quello di fatturazione sono normalmente forniti da Apple Pay. Se questa opzione è attiva, l’indirizzo di consegna di Apple Pay verrà ignorato e verrà utilizzato l’indirizzo di consegna attivo nel negozio. Ad esempio, utile per scenari di ritiro in negozio. Si applica solo ad Apple Pay Express (pulsante nel carrello o nella pagina di dettaglio del prodotto).',
    ...
    'MOLLIE_DIRECT_CAPTURE'                             => "Acquisire l'importo immediatamente",
    'MOLLIE_AUTHORIZE_CAPTURE'                          => "Autorizzare solo l'importo",
    'MOLLIE_AUTOMATIC_CAPTRE'                           => "Acquisire l'importo automaticamente",
    'MOLLIE_SHIPPED_CAPTURE'                            => "Acquisire l'importo automaticamente alla spedizione",
    ...
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE'                    => 'Mostra metodo di pagamento disabilitato quando non disponibile',
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE_HELP'               => 'Se attivo, il metodo di pagamento verrà mostrato come disabilitato nella pagina di pagamento se non è disponibile a causa delle impostazioni della valuta, degli importi minimi/massimi o delle restrizioni per paese da parte di Mollie.',
);
