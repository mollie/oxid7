...
$aLang = array(
    ...
    'MOLLIE_ADMIN_API_LOGS_SELECT_ENTRY'                => 'Please select an element from the list above.',
    ...
    'MOLLIE_CREDITCARD_DATA_INPUT_HELP'                 => 'This option defines where the customer must enter the credit card information.<br>The recommended method is "Input in shop checkout with iframe form inputs".',
    ...
    'MOLLIE_ALTLOGO_ERROR'                              => 'There has been an error during the file upload. Please check the permission of the folder SHOPROOT/vendor/mollie/mollie-oxid7/assets/img/',
    ...
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS'          => 'Ignore Apple Pay Express delivery address',
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS_HELP'     => 'Both the delivery and billing address are normally provided by Apple Pay. If this is enabled, the delivery address from Apple Pay will be ignored and the active delivery address in the shop will be used instead. For example, useful for store pickup scenarios. Only applies to Apple Pay Express (button on cart or product detail page).',
    ...
    'MOLLIE_PAYMENT_DISABLED_ACTIVATION'                => 'This Mollie payment method can no longer be activated as it will be removed soon!',
    ...
    'MOLLIE_DIRECT_CAPTURE'                             => 'Capture amount immediately',
    'MOLLIE_AUTHORIZE_CAPTURE'                          => 'Authorize amount only',
    'MOLLIE_AUTOMATIC_CAPTURE'                          => 'Capture amount automatically',
    'MOLLIE_SHIPPED_CAPTURE'                            => 'Capture amount automatically upon shipment',
