...
$aLang = array(
    ...
    'HELP_SHOP_MODULE_sMollieCronFinishOrdersActive'    => 'Deze cronjob heeft de taak om bestellingen af te ronden waarbij de klant met succes heeft betaald, maar schijnbaar niet naar de winkel is teruggekeerd om het bestelproces te voltooien. De cronjob rondt alleen bestellingen af binnen de periode die is ingesteld in de configuratie "Tijdvenster waarin wordt geprobeerd betaalde maar niet voltooide bestellingen af te ronden".<br> <br> Om deze cronjob te laten werken, moet je er in aanvulling op deze checkbox voor zorgen dat de Mollie cronjob goed is ingesteld. Informatie over het instellen van de cronjob vind je in de README.md van deze module.',
