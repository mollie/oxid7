...
$aLang = array(
    ...
    'SHOP_MODULE_sMollieCronFinishOrdersActive'         => 'Cronjob "Voltooien van betaalde/geautoriseerde maar niet afgeronde bestellingen" actief',
    'SHOP_MODULE_iMollieCronFinishOrdersDays'           => 'Tijdsvenster waarin wordt geprobeerd betaalde/geautoriseerde maar niet afgeronde bestellingen te voltooien',
    ...
    'HELP_SHOP_MODULE_sMollieCronFinishOrdersActive'    => 'Deze cronjob heeft de taak om bestellingen af te ronden waarbij de klant met succes heeft betaald, maar schijnbaar niet naar de winkel is teruggekeerd om het bestelproces te voltooien. De cronjob rondt alleen bestellingen af binnen de periode die is ingesteld in de configuratie "Tijdsvenster waarin wordt geprobeerd betaalde/geautoriseerde maar niet afgeronde bestellingen te voltooien".<br> <br> Om deze cronjob te laten werken, moet je er in aanvulling op deze checkbox voor zorgen dat de Mollie cronjob goed is ingesteld. Informatie over het instellen van de cronjob vind je in de README.md van deze module.',
    ...
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS'          => 'Apple Pay Express afleveradres negeren',
    'MOLLIE_APPLE_PAY_IGNORE_DELIVERY_ADDRESS_HELP'     => 'Zowel het afleveradres als het factuuradres worden normaal gesproken door Apple Pay geleverd. Als dit is ingeschakeld, wordt het afleveradres van Apple Pay genegeerd en wordt het actieve afleveradres in de shop gebruikt. Bijvoorbeeld handig voor afhalen in de winkel. Alleen van toepassing op Apple Pay Express (knop op de winkelwagen- of productdetailpagina).',
    ...
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE'                    => 'Toon betaalmethode als uitgeschakeld wanneer niet beschikbaar',
    'MOLLIE_SHOW_WHEN_NOT_AVAILABLE_HELP'               => 'Indien ingeschakeld, wordt de betaalmethode als uitgeschakeld weergegeven op de betaalpagina als deze niet beschikbaar is vanwege valuta-instellingen, min/max bedragen of landbeperkingen vanuit Mollie.',
);
