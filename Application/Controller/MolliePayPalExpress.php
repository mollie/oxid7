...
class MolliePayPalExpress extends FrontendController
{
    ...
    public function initSession()
    {
        ...
        try {
            ...
            $oRequestLog->logRequest($aParams, $oSession, null, Registry::getConfig()->getShopId());
            ...
            $oRequestLog->logExceptionResponse($aParams, $exc->getCode(), $exc->getMessage(), PayPalExpress::OXID, null, Registry::getConfig()->getShopId());
    ...
    public function handlePayPalReturn()
    {
        ...
        try {
            ...
            $oRequestLog->logRequest(['sessionId' => $sSessionId], $oSession, null, Registry::getConfig()->getShopId());
        } catch (\Exception $exc) {
            $oRequestLog->logExceptionResponse(['sessionId' => $sSessionId], $exc->getCode(), $exc->getMessage(), PayPalExpress::OXID, null, Registry::getConfig()->getShopId());
